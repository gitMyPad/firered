...
const u16 gMenuInfoMoveType_Pal[] = INCBIN_U16("graphics/interface/split_icons_battle.gbapal");
const u8 gMenuInfoElements_Gfx[] = INCBIN_U8("graphics/interface/menu_info.4bpp");
const u8 gMenuInfoMoveType_Gfx[] = INCBIN_U8("graphics/interface/split_icons_battle.4bpp");
