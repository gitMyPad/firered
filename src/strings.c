...
const u8 gText_PokeSum_Controls_PageStats[] = _("{DPAD_LEFTRIGHT}PAGE {L_BUTTON}{R_BUTTON}FLIP");
const u8 gText_PokeSum_Controls_PageStatsIV[] = _("INNATE {L_BUTTON}{R_BUTTON}FLIP");
const u8 gText_PokeSum_Controls_PageStatsEV[] = _("EV {L_BUTTON}{R_BUTTON}FLIP");
