...
extern const u16 gMenuInfoMoveType_Pal[];
extern const u8 gMenuInfoElements_Gfx[];
extern const u8 gMenuInfoMoveType_Gfx[];
...
extern const u32 gItemIcon_SoulBrace[];
extern const u32 gItemIconPalette_SoulBrace[];
