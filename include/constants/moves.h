...
// Target flags
#define MOVETARGET_STATUS       (0x0 << 0)
#define MOVETARGET_ATTACK       (0x1 << 0)
#define MOVETARGET_MASK         (0x1 << 0)

#define MOVETARGET_TARGET_DEF   (0x1 << 1)
#define MOVETARGET_TARGET_SPDEF (0x0 << 1)
#define MOVETARGET_TARGET_MASK  (0x1 << 1)

#define MOVETARGET_SOURCE_ATK   (0x1 << 2)
#define MOVETARGET_SOURCE_SPATK (0x2 << 2)
#define MOVETARGET_SOURCE_DEF   (0x3 << 2)
#define MOVETARGET_SOURCE_SPDEF (0x4 << 2)
#define MOVETARGET_SOURCE_SPEED (0x5 << 2)
#define MOVETARGET_SOURCE_MASK  (0x7 << 2)

#define MOVETARGET_BASE_PHYSICAL (MOVETARGET_ATTACK | MOVETARGET_TARGET_DEF)
#define MOVETARGET_BASE_SPECIAL  (MOVETARGET_ATTACK | MOVETARGET_TARGET_SPDEF)

#define MOVETARGET_FLAG_PHYSICAL (MOVETARGET_BASE_PHYSICAL | MOVETARGET_SOURCE_ATK)
#define MOVETARGET_FLAG_SPECIAL  (MOVETARGET_BASE_SPECIAL  | MOVETARGET_SOURCE_SPATK)

#define MOVETARGET_FLAG_P_SPATK  (MOVETARGET_BASE_PHYSICAL | MOVETARGET_SOURCE_SPATK)
#define MOVETARGET_FLAG_P_DEF    (MOVETARGET_BASE_PHYSICAL | MOVETARGET_SOURCE_DEF)
#define MOVETARGET_FLAG_P_SPDEF  (MOVETARGET_BASE_PHYSICAL | MOVETARGET_SOURCE_SPDEF)
#define MOVETARGET_FLAG_P_SPEED  (MOVETARGET_BASE_PHYSICAL | MOVETARGET_SOURCE_SPEED)

#define MOVETARGET_FLAG_S_ATK    (MOVETARGET_BASE_SPECIAL  | MOVETARGET_SOURCE_ATK)
#define MOVETARGET_FLAG_S_DEF    (MOVETARGET_BASE_SPECIAL  | MOVETARGET_SOURCE_DEF)
#define MOVETARGET_FLAG_S_SPDEF  (MOVETARGET_BASE_SPECIAL  | MOVETARGET_SOURCE_SPDEF)
#define MOVETARGET_FLAG_S_SPEED  (MOVETARGET_BASE_SPECIAL  | MOVETARGET_SOURCE_SPEED)

#define MOVETARGET_FLAG_STATUS   (MOVETARGET_STATUS)
